...
- **Decisiones (popups)**: 45+ eventos. No pausan el juego: se acumulan en una bandeja con cuenta regresiva y, si no decidís, pasa la opción pasiva. Hay eventos generales, **incidentes** cuya probabilidad diaria crece con la deuda técnica, **modo Argentina** (dólar, cepo, AFIP, paro, luz, Mundial, monotributo) y **dinámicos** (alguien con otra oferta: contraoferta, dejarlo ir o stock options; burnout del fundador).
