...
export const IDEAS_POR_SECTOR: Record<string, string[]> = {
  saas: [
    ...
    "Sueldos para pymes que odian el software",
    "Un asistente que escribe las minutas de reunión",
    "Historia clínica para veterinarias",
    "Reservas para canchas de fútbol 5",
    "Firma digital para inmobiliarias",
    "Un panel que junta todas las métricas del negocio",
    "Control de stock para ferreterías",
    "Un chatbot que atiende a la obra social",
    "Encuestas de clima laboral que nadie odia",
    "Un ERP para bodegas chicas",
    "Onboarding de empleados sin PDFs",
    "Un helpdesk que contesta antes de que preguntes",
    "Contratos legales que se redactan solos",
    "Un buscador de becas para estudiantes",
    "Duolingo para aprender a programar",
  ],
  fintech: [
    "Un banco para adolescentes",
    "Un asistente que negocia tus cuentas",
    "Una app que te dice cuánto te comió la inflación",
    "Cobros por QR para ferias y puestos",
    "Adelanto de sueldo sin pasar por el prestamista",
    "Una prepaga para la mensualidad de los pibes",
    "Scoring crediticio para monotributistas",
    "Facturas que se cobran solas por débito",
    "Un fondo de inversión explicado en criollo",
    "Seguros que se contratan en tres clicks",
    "Dividir gastos de asados y viajes",
    "Un simulador de créditos sin letra chica",
    "Cambio de divisas entre personas, sin cueva",
    "Una vaquita digital para juntar entre amigos",
    "Contabilidad automática para freelancers",
    "Cuotas sin tarjeta para comercios de barrio",
    "Un robo-advisor que habla como tu tío",
    "Débitos recurrentes para clubes y gimnasios",
    "Una app que te avisa antes de quedar en rojo",
    "Un comparador de comisiones bancarias",
  ],
  devtools: [
    "Un Copilot pero para SQL",
    "Un linter que además te explica el reto",
    "Deploys que se revierten solos cuando rompés prod",
    "Un buscador de logs que entiende preguntas",
    "Documentación que se escribe sola desde el código",
    "Un CI que corre solo los tests que importan",
    "Feature flags para equipos de dos personas",
    "Un playground para probar APIs sin Postman",
    "Monitoreo que te avisa por WhatsApp",
    "Tests generados desde los bugs de producción",
    "Migraciones de base de datos sin sudar",
    "Un asistente que revisa los pull requests",
    "API keys que nunca terminan en el repo",
    "Un sandbox para probar librerías antes de instalarlas",
    "Traducir código viejo de PHP a lo que sea",
    "Un panel de costos de infraestructura en vivo",
    "Entornos de desarrollo que arrancan en 10 segundos",
    "Un detector de deuda técnica que la prioriza",
    "Changelogs armados desde los commits",
    "Un chat que responde con el código de tu repo",
  ],
  delivery: [
    ...
    "Delivery de asado listo para la parrilla",
    "Un marketplace de repuestos usados",
    "Alquiler de herramientas entre vecinos",
    "Un Uber para fletes y mudanzas chicas",
    "Un marketplace de tortas caseras",
    "Peluquería a domicilio con turno online",
    "Una app para vender lo que le sobró al restaurante",
    "Un marketplace de instrumentos usados",
    "Profesores particulares a domicilio",
    "Un Uber para changas y arreglos del hogar",
    "Ropa de segunda mano, pero curada",
    "Verdulería de productores directos",
    "Un Airbnb para quinchos y parrillas",
    "Un marketplace de bicicletas restauradas",
    "Tinder para encontrar cofundador",
    "Un GPS para colectivos del interior",
  ],
  crypto: [
    "Sueldos en cripto para nómades",
    "Una billetera que tu abuela pueda usar",
    "Un DEX de memecoins con nombres de comida",
    "Una stablecoin atada al precio del asado",
    "Un staking que explica el riesgo de verdad",
    "Un detector de rug pulls antes de que pase",
    "Micropagos para dejarle propina a creadores",
    "Un DAO para financiar clubes de barrio",
    "Remesas a Latinoamérica sin comisión",
    "Un exchange entre personas, sin cuevas",
    "Tokenizar campos y cosechas",
    "Un play-to-earn que no sea un esquema piramidal",
    "Un bot de trading que te avisa cuándo frenar",
    "Escrow con contratos inteligentes para compraventas",
    "Un índice cripto para el que no entiende nada",
    "Identidad on-chain para hacer trámites",
    "Un seguro contra hackeos de billetera",
    "Entradas de recitales tokenizadas",
    "Un explorador de blockchain en criollo",
    "Cobrar en dólares digitales desde el exterior",
  ],
  ai: [
    "Un agente que contesta tus mails",
    "IA que corrige exámenes",
    "IA que arma la lista del súper",
    "Fotos de producto hechas con IA",
    "Un agente que atiende el WhatsApp del negocio",
    "IA que resume las reuniones a las que faltaste",
    "Un agente que busca y aplica a trabajos por vos",
    "IA que edita los videos para redes",
    "Un agente que hace las compras del mes",
    "IA que arma el plan de entrenamiento",
    "Un agente que negocia con proveedores",
    "IA que detecta fraude en las facturas",
    "Un agente que te agenda las reuniones",
    "IA que traduce los papeles del médico",
    "Un agente que arma el itinerario del viaje",
    "IA que revisa contratos antes de firmar",
    "Un agente que responde las reseñas de Google",
    "IA que arma presentaciones desde un audio",
    "Un agente que ordena y etiqueta tus fotos",
    "IA que hace la parte administrativa del estudio",
  ],
};
...
export const STARTUP_NAME_PARTS: Record<string, { a: string[]; b: string[] }> = {
  saas: {
    a: ["Nube", "Panel", "Flujo", "Tarea", "Orden", "Simple", "Clara", "Suite", "Tablero", "Ficha", "Rutina", "Cuadro", "Planilla", "Gestio"],
    b: ["ly", "fy", "io", "hub", "app", "flow", "base", "ify", "suite", "ar"],
  },
  fintech: {
    a: ["Mango", "Peso", "Guita", "Caja", "Bolsi", "Moneda", "Plata", "Cuenta", "Vuelto", "Ahorro", "Chanta", "Billet", "Finan", "Fiado"],
    b: ["pay", "bank", "fy", "ly", "ar", "io", "cash", "wallet", "app", "x"],
  },
  devtools: {
    a: ["Deploy", "Commit", "Merge", "Stack", "Kernel", "Bash", "Log", "Repo", "Branch", "Compil", "Debug", "Script", "Patch", "Runtime"],
    b: ["ly", "io", "dev", "lab", "hub", "ci", "stack", "fy", "kit", "ops"],
  },
  delivery: {
    a: ["Cerca", "Barrio", "Vuelta", "Manda", "Envío", "Puerta", "Trueque", "Feria", "Changa", "Vecino", "Rápido", "Punto", "Reparto", "Canasta"],
    b: ["ya", "go", "app", "ar", "hub", "express", "market", "ly", "mano", "fy"],
  },
  crypto: {
    a: ["Token", "Bloque", "Cripto", "Satoshi", "Wallet", "Cadena", "Mina", "Hash", "Ledger", "Nodo", "Zero", "Meta", "Luna", "Gas"],
    b: ["chain", "fi", "x", "dao", "coin", "swap", "verse", "io", "ly", "net"],
  },
  ai: {
    a: ["Neuro", "Prompt", "Agente", "Sinapsis", "Vector", "Modelo", "Cerebro", "Copiloto", "Mente", "Oráculo", "Token", "Infer", "Cogni", "Razona"],
    b: ["mind", "ai", "gpt", "bot", "ly", "io", "brain", "lab", "agent", "fy"],
  },
};
